...
with app.app_context():
    ...
    user1 = User(
        username="captainjoe",
        email="joe@yachtaway.com",
        password_hash=generate_password_hash("password123")
    )
    user2 = User(
        username="sailorjane",
        email="jane@yachtaway.com",
        password_hash=generate_password_hash("sailorpass")
    )
    ...
    yacht1 = Yacht(
        ...
        capacity=8,
        image_url="http://localhost:5000/images/yacht1.jpeg"
    )
    yacht2 = Yacht(
        name="Ocean Pearl",
        ...
        capacity=6,
        image_url="http://localhost:5000/images/yacht2.jpeg"
    )
    yacht3 = Yacht(
        name="Blue Lagoon",
        description="Modern yacht with AC and WiFi.",
        location="Watamu",
        price_per_day=1900.00,
        capacity=10,
        image_url="http://localhost:5000/images/yacht3.jpeg"
    )
    ...
    ba2 = BookingAddOn(
        booking_id=booking1.id,
        addon_id=addon3.id,
        note="Bring Afrobeat playlist"
    )
    ba3 = BookingAddOn(
        booking_id=booking2.id,
        addon_id=addon2.id,
        note="Kids-friendly gear"
    )
